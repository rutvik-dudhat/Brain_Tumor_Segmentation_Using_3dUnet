...
TRAIN_DATASET_PATH = r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/'
...
imwrite(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/combined255.tif', combined_x)
np.save(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/combined255.npy', combined_x)
# Verify image is being read properly
#my_img= imread(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/combined255.tif')

my_img = np.load(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/combined255.npy')
...
t2_list = sorted(glob.glob(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*t2.nii'))
t1ce_list = sorted(glob.glob(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*t1ce.nii'))
flair_list = sorted(glob.glob(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*flair.nii'))
mask_list = sorted(glob.glob(r'/home/d_rutvik/BraTS2020/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*seg.nii'))
...
for img in range(len(t2_list)):  # Using t1_list as all lists are of same size
    ...
    if (1 - (counts[0] / counts.sum())) > 0.01:  # At least 1% useful volume with labels that are not 0
        ...
        np.save(r'/home/d_rutvik/BraTS2020/input_data/images/image_' + str(img) + '.npy', temp_combined_images)
        np.save(r'/home/d_rutvik/BraTS2020/input_data/masks/mask_' + str(img) + '.npy', temp_mask)
...
input_folder = r'/home/d_rutvik/BraTS2020/input_data/' #input3
output_folder = r'/home/d_rutvik/BraTS2020/input_data_2/'  #input128
# Split with a ratio.
